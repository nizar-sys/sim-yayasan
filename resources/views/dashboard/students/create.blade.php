                ...
                <div class="card-body">
                    <form action="{{ route('students.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" placeholder="Nama Lengkap Siswa" value="{{ old('nama') }}"
                                        name="nama">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nik') is-invalid @enderror"
                                        id="nik" placeholder="NIK Siswa" value="{{ old('nik') }}"
                                        name="nik">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nisn') is-invalid @enderror"
                                        id="nisn" placeholder="NISN Siswa" value="{{ old('nisn') }}"
                                        name="nisn">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_kk') is-invalid @enderror"
                                        id="no_kk" placeholder="NO KK Siswa" value="{{ old('no_kk') }}"
                                        name="no_kk">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" placeholder="Email Siswa" value="{{ old('email') }}"
                                        name="email">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_registrasi_akta_lahir') is-invalid @enderror"
                                        id="no_registrasi_akta_lahir" placeholder="NO Registrasi Akta Lahir Siswa"
                                        value="{{ old('no_registrasi_akta_lahir') }}" name="no_registrasi_akta_lahir">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('agama') is-invalid @enderror"
                                        id="agama" placeholder="Agama Siswa"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        id="alamat" placeholder="Alamat Jalan Siswa"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('rt') is-invalid @enderror"
                                        id="rt" placeholder="Alamat RT Siswa"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('rw') is-invalid @enderror"
                                        id="rw" placeholder="Alamat RW Siswa"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('dusun') is-invalid @enderror"
                                        id="dusun" placeholder="Dusun Siswa"
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kelurahan') is-invalid @enderror"
                                        id="kelurahan" placeholder="Kelurahan Siswa"
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                        id="kecamatan" placeholder="Kecamatan Siswa"
                                        value="{{ old('kecamatan') }}" name="kecamatan">
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group mb-3">
                                    <label for="kode_pos">Kode POS Siswa</label>
                                    <input type="number" class="form-control @error('kode_pos') is-invalid @enderror"
                                        id="kode_pos" placeholder="Kode POS Siswa"
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_tinggal') is-invalid @enderror"
                                        ...
                                        value="{{ old('tempat_tinggal') }}" name="tempat_tinggal">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('moda_transportasi') is-invalid @enderror"
                                        id="moda_transportasi" placeholder="Moda Transportasi Siswa"
                                        value="{{ old('moda_transportasi') }}" name="moda_transportasi">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('anak_ke') is-invalid @enderror"
                                        ...
                                        value="{{ old('anak_ke') }}" name="anak_ke">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_kip') is-invalid @enderror"
                                        id="no_kip" placeholder="NO KIP Siswa"
                                        value="{{ old('no_kip') }}" name="no_kip">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_masuk_sekolah') is-invalid @enderror"
                                        id="tanggal_masuk_sekolah" placeholder="Tanggal Masuk Sekolah"
                                        value="{{ old('tanggal_masuk_sekolah') }}" name="tanggal_masuk_sekolah">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_peserta_ujian_nasional') is-invalid @enderror"
                                        id="no_peserta_ujian_nasional" placeholder="NO Peserta UN SMP"
                                        value="{{ old('no_peserta_ujian_nasional') }}" name="no_peserta_ujian_nasional">

@extends('layouts.app')
@section('title', 'Tambah Data Penugasan Pendidik')

@section('title-header', 'Tambah Data Penugasan Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('assignments.index') }}">Data Penugasan Pendidik</a></li>
    <li class="breadcrumb-item active">Tambah Data Penugasan Pendidik</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Penugasan Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('assignments.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nomor_surat_tugas') is-invalid @enderror"
                                        id="nomor_surat_tugas" placeholder="Nomor Surat Penugasan Pendidik" value="{{ old('nomor_surat_tugas') }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_surat_tugas') is-invalid @enderror"
                                        id="tanggal_surat_tugas" placeholder="Tanggal Surat Penugasan Pendidik" value="{{ old('tanggal_surat_tugas') }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tmt_tugas') is-invalid @enderror"
                                        id="tmt_tugas" placeholder="TMT Penugasan Pendidik" value="{{ old('tmt_tugas') }}"
                                        name="tmt_tugas">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('status_sekolah_induk') is-invalid @enderror"
                                        id="status_sekolah_induk" placeholder="Status Sekolah Induk Penugasan Pendidik" value="{{ old('status_sekolah_induk') }}"

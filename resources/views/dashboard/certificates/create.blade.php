@extends('layouts.app')
@section('title', 'Tambah Data Riwayat Sertifikasi Pendidik')

@section('title-header', 'Tambah Data Riwayat Sertifikasi Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('certificates.index') }}">Data Riwayat Sertifikasi Pendidik</a></li>
    <li class="breadcrumb-item active">Tambah Data Riwayat Sertifikasi Pendidik</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Riwayat Sertifikasi Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('certificates.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nomor_sertifikasi') is-invalid @enderror"
                                        id="nomor_sertifikasi" placeholder="Nomor Riwayat Sertifikasi Pendidik" value="{{ old('nomor_sertifikasi') }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nomor_peserta') is-invalid @enderror"
                                        id="nomor_peserta" placeholder="Nomor Peserta Sertifikasi Pendidik" value="{{ old('nomor_peserta') }}"
                                        name="nomor_peserta">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_sertifikasi') is-invalid @enderror"
                                        id="jenis_sertifikasi" placeholder="Jenis Riwayat Sertifikasi Pendidik" value="{{ old('jenis_sertifikasi') }}"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bidang_studi') is-invalid @enderror"
                                        id="bidang_studi" placeholder="Bidang Studi Riwayat Sertifikasi Pendidik" value="{{ old('bidang_studi') }}"
                                        name="bidang_studi">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun_sertifikasi') is-invalid @enderror"
                                        id="tahun_sertifikasi" placeholder="Tahun Riwayat Sertifikasi Pendidik" value="{{ old('tahun_sertifikasi') }}"

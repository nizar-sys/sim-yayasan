@extends('layouts.app')
@section('title', 'Ubah Data Riwayat Pendidikan Formal Pendidik')

@section('title-header', 'Ubah Data Riwayat Pendidikan Formal Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('educations.index') }}">Data Riwayat Pendidikan Formal Pendidik</a></li>
    <li class="breadcrumb-item active">Ubah Data Riwayat Pendidikan Formal Pendidik</li>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Data Riwayat Pendidikan Formal Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('educations.update', $education->id) }}" method="POST" role="form"
                                    ...
                                    <select class="form-control @error('pendidik_id') is-invalid @enderror" id="pendidik_id"
                                        ...
                                        @foreach ($dataPendidik as $pendidik)
                                            <option value="{{ $pendidik->id }}"
                                                @if (old('pendidik_id', $education->pendidik_id) == $pendidik->id) selected @endif>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bidang_studi') is-invalid @enderror"
                                        id="bidang_studi" placeholder="Bidang Studi" value="{{ old('bidang_studi', $education->bidang_studi) }}"
                                        name="bidang_studi">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nis_nim') is-invalid @enderror"
                                        id="nis_nim" placeholder="NIS / NIM" value="{{ old('nis_nim', $education->nis_nim) }}" name="nis_nim">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('jenjang_pendidikan', $education->jenjang_pendidikan) }}" name="jenjang_pendidikan">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('gelar_akademik') is-invalid @enderror"
                                        ...
                                        value="{{ old('gelar_akademik', $education->gelar_akademik) }}" name="gelar_akademik">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('satuan_pendidikan', $education->satuan_pendidikan) }}" name="satuan_pendidikan">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('fakultas') is-invalid @enderror"
                                        id="fakultas" placeholder="Fakultas" value="{{ old('fakultas', $education->fakultas) }}"
                                        name="fakultas">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kependidikan') is-invalid @enderror"
                                        id="kependidikan" placeholder="Kependidikan" value="{{ old('kependidikan', $education->kependidikan) }}"
                                        name="kependidikan">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun_masuk') is-invalid @enderror"
                                        id="tahun_masuk" placeholder="Tahun Masuk" value="{{ old('tahun_masuk', $education->tahun_masuk) }}"
                                        name="tahun_masuk">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun_lulus') is-invalid @enderror"
                                        id="tahun_lulus" placeholder="Tahun Lulus" value="{{ old('tahun_lulus', $education->tahun_lulus) }}"
                                        name="tahun_lulus">
                                    ...
                                    <select class="form-control @error('masih_studi') is-invalid @enderror"
                                        ...
                                        @foreach ($options as $masih_studi)
                                            <option value="{{ $masih_studi }}"
                                                @if (old('masih_studi', $education->masih_studi) == $masih_studi) selected @endif>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('semester') is-invalid @enderror"
                                        id="semester" placeholder="Semester" value="{{ old('semester', $education->semester) }}"
                                        name="semester">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('rata_rata_nilai_ipk', $education->rata_rata_nilai_ipk) }}" name="rata_rata_nilai_ipk">

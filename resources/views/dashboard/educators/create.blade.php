...
@section('title-header', 'Tambah Data Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('educators.index') }}">Data Pendidik</a></li>
    <li class="breadcrumb-item active">Tambah Data Pendidik</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('educators.store') }}" method="POST" role="form"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" placeholder="Nama Lengkap Pendidik" value="{{ old('nama') }}"
                                        name="nama">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nik_paspor') is-invalid @enderror"
                                        id="nik_paspor" placeholder="NIK / Paspor Pendidik" value="{{ old('nik_paspor') }}"
                                        name="nik_paspor">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" placeholder="Email Pendidik" value="{{ old('email') }}"
                                        name="email">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_ibu_kandung') }}" name="nama_ibu_kandung">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    <label for="password">Password Pendidik</label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                        id="password" placeholder="Password Pendidik" value="{{ old('password') }}"
                                        name="password">

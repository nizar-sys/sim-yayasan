@extends('layouts.app')
@section('title', 'Tambah Data Riwayat Karir Pendidik')

@section('title-header', 'Tambah Data Riwayat Karir Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('carriers.index') }}">Data Riwayat Karir Pendidik</a></li>
    <li class="breadcrumb-item active">Tambah Data Riwayat Karir Pendidik</li>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Riwayat Karir Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('carriers.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenjang_pendidikan') is-invalid @enderror"
                                        id="jenjang_pendidikan" placeholder="Jenjang Pendidikan" value="{{ old('jenjang_pendidikan') }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_lembaga') is-invalid @enderror"
                                        id="jenis_lembaga" placeholder="Jenis Lembaga" value="{{ old('jenis_lembaga') }}"
                                        name="jenis_lembaga">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('status_kepegawaian') is-invalid @enderror"
                                        id="status_kepegawaian" placeholder="Status Kepegawaian" value="{{ old('status_kepegawaian') }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_ptk') is-invalid @enderror"
                                        id="jenis_ptk" placeholder="Jenis PTK" value="{{ old('jenis_ptk') }}"
                                        name="jenis_ptk">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lembaga_pengangkat') is-invalid @enderror"
                                        id="lembaga_pengangkat" placeholder="Lembaga Pengangkat" value="{{ old('lembaga_pengangkat') }}"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_sk_kerja') is-invalid @enderror"
                                        id="no_sk_kerja" placeholder="NO SK Kerja" value="{{ old('no_sk_kerja') }}"
                                        name="no_sk_kerja">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tgl_sk_kerja') is-invalid @enderror"
                                        id="tgl_sk_kerja" placeholder="Tanggal SK Kerja" value="{{ old('tgl_sk_kerja') }}"
                                        name="tgl_sk_kerja">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tmt_kerja') is-invalid @enderror"
                                        id="tmt_kerja" placeholder="TMT Kerja" value="{{ old('tmt_kerja') }}"
                                        name="tmt_kerja">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tst_kerja') is-invalid @enderror"
                                        id="tst_kerja" placeholder="TST Kerja" value="{{ old('tst_kerja') }}"
                                        name="tst_kerja">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_kerja') is-invalid @enderror"
                                        id="tempat_kerja" placeholder="Tempat Kerja" value="{{ old('tempat_kerja') }}"
                                        name="tempat_kerja">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('mapel_diajarkan') is-invalid @enderror"
                                        id="mapel_diajarkan" placeholder="Mapel Diajarkan" value="{{ old('mapel_diajarkan') }}"

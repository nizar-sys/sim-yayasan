@extends('layouts.app')
@section('title', 'Tambah Data Anak Pendidik')

@section('title-header', 'Tambah Data Anak Pendidik')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('childrens.index') }}">Data Anak Pendidik</a></li>
    <li class="breadcrumb-item active">Tambah Data Anak Pendidik</li>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Anak Pendidik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('childrens.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_anak') is-invalid @enderror"
                                        id="nama_anak" placeholder="Nama Anak" value="{{ old('nama_anak') }}"
                                        name="nama_anak">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                        id="tempat_lahir" placeholder="Tempat Lahir" value="{{ old('tempat_lahir') }}"
                                        name="tempat_lahir">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                        id="tanggal_lahir" placeholder="Tanggal Lahir" value="{{ old('tanggal_lahir') }}"
                                        name="tanggal_lahir">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun_masuk_sekolah') is-invalid @enderror"
                                        id="tahun_masuk_sekolah" placeholder="Nama Anak" value="{{ old('tahun_masuk_sekolah') }}"
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenjang') is-invalid @enderror"
                                        id="jenjang" placeholder="Jenjang" value="{{ old('jenjang') }}"
                                        name="jenjang">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nisn') is-invalid @enderror"
                                        id="nisn" placeholder="NISN" value="{{ old('nisn') }}"
                                        name="nisn">
